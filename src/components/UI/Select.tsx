...
interface IPropes{
    selected:{name:string,imag:string};
    setSelected:(category:Icategory)=>void
}
const Select=({selected,setSelected}:IPropes)=> {
  ...
  return (
    <Listbox value={selected} onChange={setSelected}>
      ...
      <div className="relative ">
        <ListboxButton className="grid w-full cursor-default grid-cols-1 rounded-md bg-white py-3 pr-10 pl-3 text-left text-black outline-1 -outline-offset-1 outline-white/10 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-indigo-500 sm:text-sm/6">
